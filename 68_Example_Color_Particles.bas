...
'  ----------------------------------------------------------------------------
'  Example 68: Color Particle Effect
...
iAppTitle( "Example 68: Color Particle Effect" )
...
iAttractionAffector ( SmokeParticles, 10.0, 0.0, 0.0, 20.0, False, 1, 1, 1 )

iRotationAffector ( SmokeParticles, 0.0, -120.0, 0.0, 0.0,0.0,0.0 )


' BANK FOR COLORS	-change the color of particles using a bank
Dim Colors(20) As Integer
Dim punt As Integer Ptr

punt=@Colors(0)
punt[0]=iMakeARGB(0,255,255,128)		 '  yellow white
punt[4]=iMakeARGB(0,255,128,0)			 '  yellow
punt[8]=iMakeARGB(0,255,0,0)				 '  red
punt[12]=iMakeARGB(0,0,0,128)				 '  slight blue
punt[16]=iMakeARGB(255,0,0,0)				 '  black and faded

' BANK FOR COLOR TIMES
Dim Times(20) As Integer
punt=@Times(0)
punt[0]=400								 ' milliseconds
punt[4]=800								 ' milliseconds
punt[8]=1250								 ' milliseconds
punt[12]=1500								 ' milliseconds
punt[16]=2000								 ' milliseconds

iColorAffector( SmokeParticles, 5, @Colors(0), @Times(0), True )  '  5 IS NUMBER OF ELEMENTS PROVIDED IN COLOR BANK
