...
'  ----------------------------------------------------------------------------
'  Example 99: XEffects Dynamic Shadows Variance Shadow Maps
...
iXFXStart( True, True, True )

'  set the window caption
iAppTitle( "Example 99: XEffects Dynamic Shadows Variance Shadow Maps" )

'  load a mesh this acts as a blue print for the model
SceneNode = iLoadAnimMesh( "./media/temple.obj", False )
...
' SceneNode = iAddMeshToScene( RoomMesh )
...
iXFXSetAmbientColor( 0,128,128,128)
